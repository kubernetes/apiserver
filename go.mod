...
replace (
	...
	k8s.io/api => k8s.io/api v0.0.0-20200309184952-bdcd0206320a
	...
	k8s.io/component-base => k8s.io/component-base v0.0.0-20200308163138-58a21142ef86
)
