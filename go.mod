...
require (
	...
	k8s.io/client-go v0.0.0-20210518102918-341f59a1cb7c
...
replace (
	...
	k8s.io/apimachinery => k8s.io/apimachinery v0.0.0-20210430172414-b3737e4729cb
	k8s.io/client-go => k8s.io/client-go v0.0.0-20210518102918-341f59a1cb7c
