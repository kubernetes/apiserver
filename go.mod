...
require (
	...
	k8s.io/api v0.0.0-20191016110245-90d4e43bef6a
	k8s.io/apimachinery v0.0.0-20191004115701-31ade1b30762
	k8s.io/client-go v0.0.0-20191016110841-b3a3bab7e51f
	k8s.io/component-base v0.0.0-20191016111233-98b434ef44d7
	k8s.io/klog v0.3.1
...
replace (
	...
	k8s.io/api => k8s.io/api v0.0.0-20191016110245-90d4e43bef6a
	k8s.io/apimachinery => k8s.io/apimachinery v0.0.0-20191004115701-31ade1b30762
	k8s.io/client-go => k8s.io/client-go v0.0.0-20191016110841-b3a3bab7e51f
	k8s.io/component-base => k8s.io/component-base v0.0.0-20191016111233-98b434ef44d7
)
