...
require (
	...
	k8s.io/api v0.0.0-20190503030842-7e767885ee5c
...
replace (
	...
	k8s.io/api => k8s.io/api v0.0.0-20190503030842-7e767885ee5c
	k8s.io/apimachinery => k8s.io/apimachinery v0.0.0-20190502092502-a44ef629a3c9
