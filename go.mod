...
require (
	...
	k8s.io/api v0.0.0-20260904015236-802d16521c3e
	k8s.io/apimachinery v0.0.0-20260904025036-7aaae03d8eb1
	k8s.io/client-go v0.0.0-20260904055807-c66fbce8b3cd
