...
require (
	...
	k8s.io/client-go v0.0.0-20191003000414-9f8e52c915d3
	k8s.io/component-base v0.0.0-20191003000553-4ca09474ae99
	k8s.io/klog v0.4.0
...
replace (
	...
	k8s.io/client-go => k8s.io/client-go v0.0.0-20191003000414-9f8e52c915d3
	k8s.io/component-base => k8s.io/component-base v0.0.0-20191003000553-4ca09474ae99
)
