...
require (
	...
	k8s.io/client-go v0.0.0-20191121175918-3a262fe58afa
	k8s.io/component-base v0.0.0-20191121180406-c76165dbe04e
	k8s.io/klog v1.0.0
...
replace (
	...
	k8s.io/component-base => k8s.io/component-base v0.0.0-20191121180406-c76165dbe04e
)
