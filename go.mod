...
replace (
	k8s.io/api => k8s.io/api v0.0.0-20220801041257-f5e1938afa50
	...
	k8s.io/component-base => k8s.io/component-base v0.0.0-20220801042111-a3c74238b85f
)
