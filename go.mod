...
require (
	...
	k8s.io/client-go v0.0.0-20201214171407-649866c409a9
...
replace (
	...
	k8s.io/apimachinery => k8s.io/apimachinery v0.0.0-20201105122504-3f2274d12649
	k8s.io/client-go => k8s.io/client-go v0.0.0-20201214171407-649866c409a9
