...
replace (
	...
	k8s.io/apimachinery => k8s.io/apimachinery v0.0.0-20191116082940-a2a3e09234fa
	k8s.io/client-go => k8s.io/client-go v0.0.0-20191115215802-0a8a1d7b7fae
	k8s.io/component-base => k8s.io/component-base v0.0.0-20191115220130-ea09a2678486
)
