...
require (
	...
	k8s.io/component-base v0.17.4-beta.0
	k8s.io/klog v1.0.0
...
replace (
	...
	k8s.io/api => k8s.io/api v0.17.4-beta.0
	k8s.io/apimachinery => k8s.io/apimachinery v0.17.4-beta.0
	k8s.io/client-go => k8s.io/client-go v0.17.4-beta.0
	k8s.io/component-base => k8s.io/component-base v0.17.4-beta.0
)
