...
require (
	...
	k8s.io/apimachinery v0.0.0-20190606104813-5a6182816fbf
...
replace (
	...
	k8s.io/apimachinery => k8s.io/apimachinery v0.0.0-20190606104813-5a6182816fbf
	k8s.io/client-go => k8s.io/client-go v0.0.0-20190602130007-e65ca70987a6
