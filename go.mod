...
require (
	...
	k8s.io/client-go v0.19.0-alpha.0
	k8s.io/component-base v0.19.0-alpha.0
	k8s.io/klog v1.0.0
...
replace (
	...
	k8s.io/client-go => k8s.io/client-go v0.19.0-alpha.0
	k8s.io/component-base => k8s.io/component-base v0.19.0-alpha.0
)
