...
replace (
	k8s.io/api => k8s.io/api v0.21.0-alpha.3
	k8s.io/apimachinery => k8s.io/apimachinery v0.21.0-alpha.3
	k8s.io/client-go => k8s.io/client-go v0.21.0-alpha.3
	k8s.io/component-base => k8s.io/component-base v0.21.0-alpha.3
)
