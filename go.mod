...
require (
	...
	k8s.io/client-go v0.0.0-20220727000546-cc879cd5b66e
	k8s.io/component-base v0.0.0-20220727133141-d782b0565371
...
replace (
	...
	k8s.io/component-base => k8s.io/component-base v0.0.0-20220727133141-d782b0565371
)
