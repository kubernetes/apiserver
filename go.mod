...
require (
	...
	k8s.io/api v0.0.0-20190814101449-cd1a67b76425
	k8s.io/apimachinery v0.0.0-20190813060636-0c17871ad6fd
	k8s.io/client-go v0.0.0-20190814102431-126d4091162d
	k8s.io/component-base v0.0.0-20190814102833-1d21009ecc34
	k8s.io/klog v0.3.1
...
replace (
	...
	k8s.io/api => k8s.io/api v0.0.0-20190814101449-cd1a67b76425
	k8s.io/apimachinery => k8s.io/apimachinery v0.0.0-20190813060636-0c17871ad6fd
	k8s.io/client-go => k8s.io/client-go v0.0.0-20190814102431-126d4091162d
	k8s.io/component-base => k8s.io/component-base v0.0.0-20190814102833-1d21009ecc34
)
