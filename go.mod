...
require (
	...
	k8s.io/api v0.0.0-20191114100236-af0015acbd3e
	k8s.io/apimachinery v0.0.0-20191004115701-31ade1b30762
	k8s.io/client-go v0.0.0-20191114101333-7cb0fae7ea9f
	k8s.io/component-base v0.0.0-20191114102238-e074894be84a
	k8s.io/klog v0.3.1
...
replace (
	...
	k8s.io/api => k8s.io/api v0.0.0-20191114100236-af0015acbd3e
	k8s.io/apimachinery => k8s.io/apimachinery v0.0.0-20191004115701-31ade1b30762
	k8s.io/client-go => k8s.io/client-go v0.0.0-20191114101333-7cb0fae7ea9f
	k8s.io/component-base => k8s.io/component-base v0.0.0-20191114102238-e074894be84a
)
