...
require (
	...
	k8s.io/api v0.0.0-20200123072230-4a8a79a10e72
	k8s.io/apimachinery v0.0.0-20200123072051-a8b8767d8a3b
	k8s.io/client-go v0.0.0-20200123072453-dbf12d30bab2
	k8s.io/component-base v0.0.0-20200123073003-69ea596530e0
	k8s.io/klog v1.0.0
...
replace (
	...
	k8s.io/component-base => k8s.io/component-base v0.0.0-20200123073003-69ea596530e0
)
