...
replace (
	k8s.io/api => k8s.io/api v0.0.0-20210518101627-8d7383bd2490
	...
	k8s.io/component-base => k8s.io/component-base v0.0.0-20210518111239-b5a495af30a7
)
