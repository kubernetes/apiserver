...
replace (
	...
	k8s.io/api => k8s.io/api v0.0.0-20200424235923-139917f06b75
	...
	k8s.io/component-base => k8s.io/component-base v0.0.0-20200425080256-491960e2b475
)
