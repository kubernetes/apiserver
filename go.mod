...
require (
	...
	k8s.io/apimachinery v0.0.0-20210809200125-a653093b52fe
	k8s.io/client-go v0.0.0-20210809160556-150ce54105bd
...
replace (
	...
	k8s.io/apimachinery => k8s.io/apimachinery v0.0.0-20210809200125-a653093b52fe
