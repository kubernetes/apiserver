...
require (
	...
	k8s.io/client-go v0.0.0-20190718183606-e7110fb801cf
	k8s.io/component-base v0.0.0-20190718183726-945baa574001
	k8s.io/klog v0.3.1
...
replace (
	...
	k8s.io/client-go => k8s.io/client-go v0.0.0-20190718183606-e7110fb801cf
	k8s.io/component-base => k8s.io/component-base v0.0.0-20190718183726-945baa574001
)
