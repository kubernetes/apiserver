...
require (
	...
	k8s.io/client-go v0.20.13-rc.0
	k8s.io/component-base v0.20.13-rc.0
...
replace (
	...
	k8s.io/client-go => k8s.io/client-go v0.20.13-rc.0
	k8s.io/component-base => k8s.io/component-base v0.20.13-rc.0
)
